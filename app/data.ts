...
export const processSteps = [
  {
    ...
    copy: "Define what is changing, what is ending, what is beginning, and where the uncertainty is sitting.",
  },
  {
  ...
  },
  {
    ...
    copy: "Build a realistic plan with decisions, habits, conversations, and milestones that fit the person in front of us.",
  },
  {
    title: "Integrate the new season",
    copy: "Practice the plan, adjust what is not working, and turn progress into a stable rhythm.",
  },
];

export const resourceCards = [
  {
    title: "Transition Readiness Check",
    copy: "A short reflection for understanding where you need clarity, support, and practical next steps.",
    type: "Guide",
  },
  {
